...
![Proposed U-Net Generator for the pix2pix GAN](network architecture/discriminator_.jpg)

#### Discriminator Architecture  (PatchGAN)

![Proposed PatchGAN Discriminator for the pix2pix GAN](network architecture/generator_new__.jpg)
